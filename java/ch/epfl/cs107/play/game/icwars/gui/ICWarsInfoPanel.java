...
public class ICWarsInfoPanel implements Graphics {
    ...
    public ICWarsInfoPanel(float cameraScaleFactor) {
        ...
        float fontSize = cameraScaleFactor / ICWarsPlayerGUI.FONT_SIZE;

        Shape rect1 = new Polygon(0,0, 0,height, width,height, width,0);
        cellDetailsBackground = new ShapeGraphics(rect1, Color.DARK_GRAY, Color.BLACK, 0f, .8f, 3000f);
        Shape rect2 = new Polygon(-0.5f,0, -0.5f,height, width,height, width,0);
        unitDetailsBackground = new ShapeGraphics(rect2, Color.DARK_GRAY, Color.BLACK, 0f, .8f, 3000f);
        ...
        unitNameText = new TextGraphics("", fontSize, Color.WHITE, null, 0.0f,
                false, false, new Vector(-0.5f, -0.3f),
                TextAlign.Horizontal.LEFT, TextAlign.Vertical.MIDDLE, 1.0f, 3001f);

        unitHealthText = new TextGraphics("", fontSize, Color.WHITE, null, 0.0f,
                false, false, new Vector(-0.5f, -1.25f* fontSize -0.5f),
                TextAlign.Horizontal.LEFT, TextAlign.Vertical.MIDDLE, 1.0f, 3001f);

        unitDamageText = new TextGraphics("", fontSize, Color.WHITE, null, 0.0f,
                false, false, new Vector(-0.5f, -2.5f* fontSize -0.4f),
                TextAlign.Horizontal.LEFT, TextAlign.Vertical.MIDDLE, 1.0f, 3001f);
    }
